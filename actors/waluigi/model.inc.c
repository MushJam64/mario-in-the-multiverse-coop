...
ALIGNED8 const Texture waluigi_texture_metal_shade[] = {
#include "actors/waluigi/custom_waluigi_metal_shade.rgba16.inc.c"
};

ALIGNED8 const Texture waluigi_texture_metal_light[] = {
#include "actors/waluigi/custom_waluigi_metal_light.rgba16.inc.c"
};

ALIGNED8 static const Texture waluigi_texture_yellow_button[] = {
#include "actors/waluigi/waluigi_overalls_button.rgba16.inc.c"
};

ALIGNED8 static const Texture waluigi_texture_wings_half_1[] = {
#include "actors/waluigi/waluigi_wing.rgba16.inc.c"
};

ALIGNED8 static const Texture waluigi_texture_wings_half_2[] = {
#include "actors/waluigi/waluigi_wing_tip.rgba16.inc.c"
};

ALIGNED8 const Texture waluigi_texture_metal_wings_half_1_shade[] = {
#include "actors/waluigi/custom_waluigi_metal_wing_shade.rgba16.inc.c"
};

ALIGNED8 const Texture waluigi_texture_metal_wings_half_1_light[] = {
#include "actors/waluigi/custom_waluigi_metal_wing_light.rgba16.inc.c"
};

ALIGNED8 const Texture waluigi_texture_metal_wings_half_2_shade[] = {
#include "actors/waluigi/custom_waluigi_metal_wing_tip_shade.rgba16.inc.c"
};

ALIGNED8 const Texture waluigi_texture_metal_wings_half_2_light[] = {
#include "actors/waluigi/custom_waluigi_metal_wing_tip_light.rgba16.inc.c"
};
...
// 0x0400D3E8
static const Vtx waluigi_left_hand_closed_shared_dl_vertex_group1[] = {
...
// 0x0400D4E8
static const Vtx waluigi_left_hand_closed_shared_dl_vertex_group2[] = {
    {{{    90,     17,    -46}, 0, {     0,      0}, {0x43, 0x35, 0xa3, 0x00}}},
...
// 0x0400D5C8
static const Vtx waluigi_left_hand_closed_shared_dl_vertex_group3[] = {
...
// 0x0400D6B8
static const Vtx waluigi_left_hand_closed_shared_dl_vertex_group4[] = {
    {{{    26,    -25,    -32}, 0, {     0,      0}, {0x09, 0xc7, 0x8f, 0x00}}},
    {{{    33,      7,    -44}, 0, {     0,      0}, {0xc6, 0xfe, 0x90, 0x00}}},
    {{{    80,    -31,    -61}, 0, {     0,      0}, {0x0c, 0xb2, 0x9d, 0x00}}},
    {{{    58,    -45,      7}, 0, {     0,      0}, {0x01, 0x85, 0x1c, 0x00}}},
...
const Gfx waluigi_left_hand_closed[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPCopyLightsPlayerPart(GLOVES), // glove light, set in waluigi_misc.c
...
// 0x0400DFF8
static const Vtx waluigi_right_hand_closed_dl_vertex_group1[] = {
...
// 0x0400E0F8
static const Vtx waluigi_right_hand_closed_dl_vertex_group2[] = {
    {{{    35,      9,    -37}, 0, {     0,      0}, {0xe5, 0xf5, 0x85, 0x00}}},
...
// 0x0400E1D8
static const Vtx waluigi_right_hand_closed_dl_vertex_group3[] = {
    {{{    31,    -40,     -1}, 0, {     0,      0}, {0x43, 0xa4, 0xc9, 0x00}}},
    {{{    23,    -26,     35}, 0, {     0,      0}, {0x04, 0xc3, 0x6e, 0x00}}},
    {{{    13,    -38,     41}, 0, {     0,      0}, {0x15, 0xb3, 0x61, 0x00}}},
...
// 0x04019538
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group1[] = {
...
// 0x04019618
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group2[] = {
...
// 0x04019718
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group3[] = {
    {{{    45,    -34,     10}, 0, {     0,      0}, {0xfe, 0x9a, 0x4a, 0x00}}},
    {{{    83,    -17,     10}, 0, {     0,      0}, {0x4d, 0xbd, 0x4a, 0x00}}},
    {{{    26,     16,     28}, 0, {     0,      0}, {0xda, 0x0c, 0x78, 0x00}}},
...
// 0x04019818
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group4[] = {
    {{{    25,     -1,    -44}, 0, {     0,      0}, {0xe4, 0xe0, 0x89, 0x00}}},
    {{{    11,     29,    -52}, 0, {     0,      0}, {0xba, 0x2a, 0xa0, 0x00}}},
    {{{    26,     41,    -41}, 0, {     0,      0}, {0x05, 0x34, 0x8d, 0x00}}},
    {{{    78,     59,    -34}, 0, {     0,      0}, {0xfe, 0x0b, 0x82, 0x00}}},
...
// 0x04019918
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group5[] = {
    {{{     6,    -38,      7}, 0, {     0,      0}, {0xae, 0xab, 0x2b, 0x00}}},
    {{{     1,    -33,    -23}, 0, {     0,      0}, {0x9c, 0xbb, 0xe0, 0x00}}},
    {{{    13,    -39,    -31}, 0, {     0,      0}, {0x18, 0x9a, 0xba, 0x00}}},
...
// 0x04019A18
static const Vtx waluigi_left_hand_open_shared_dl_vertex_group6[] = {
    {{{    26,    -32,      6}, 0, {     0,      0}, {0x34, 0xa6, 0x47, 0x00}}},
    {{{    20,    -27,    -27}, 0, {     0,      0}, {0x09, 0xbf, 0x94, 0x00}}},
    {{{    41,    -37,    -36}, 0, {     0,      0}, {0xd8, 0x9b, 0xbf, 0x00}}},
    {{{    26,     16,     28}, 0, {     0,      0}, {0xda, 0x0c, 0x78, 0x00}}},
...
// 0x04019CC0
static const Vtx waluigi_right_hand_open_dl_vertex_group1[] = {
...
// 0x04019DA0
static const Vtx waluigi_right_hand_open_dl_vertex_group2[] = {
...
// 0x04019EA0
static const Vtx waluigi_right_hand_open_dl_vertex_group3[] = {
    {{{    30,     13,    -30}, 0, {     0,      0}, {0xd3, 0x03, 0x8a, 0x00}}},
    {{{    86,    -19,    -13}, 0, {     0,      0}, {0x49, 0xb6, 0xb8, 0x00}}},
    {{{    48,    -35,     -9}, 0, {     0,      0}, {0xf7, 0x94, 0xbe, 0x00}}},
...
// 0x04019FA0
static const Vtx waluigi_right_hand_open_dl_vertex_group4[] = {
    {{{    34,     43,     36}, 0, {     0,      0}, {0x0c, 0x3d, 0x6e, 0x00}}},
    {{{    20,     33,     48}, 0, {     0,      0}, {0xbf, 0x32, 0x60, 0x00}}},
    {{{    32,      2,     43}, 0, {     0,      0}, {0xe9, 0xeb, 0x7a, 0x00}}},
    {{{    75,     11,     32}, 0, {     0,      0}, {0x3c, 0x23, 0x69, 0x00}}},
...
// 0x0401A0A0
static const Vtx waluigi_right_hand_open_dl_vertex_group5[] = {
    {{{    19,    -36,     33}, 0, {     0,      0}, {0x1a, 0xa0, 0x4d, 0x00}}},
    {{{     7,    -30,     26}, 0, {     0,      0}, {0x9b, 0xc0, 0x29, 0x00}}},
    {{{    11,    -38,     -3}, 0, {     0,      0}, {0xa9, 0xaa, 0xe0, 0x00}}},
    {{{    -1,     18,     42}, 0, {     0,      0}, {0xd9, 0x23, 0x73, 0x00}}},
...
// 0x0401A1A0
static const Vtx waluigi_right_hand_open_dl_vertex_group6[] = {
    {{{    46,    -35,     37}, 0, {     0,      0}, {0xd8, 0xa2, 0x4a, 0x00}}},
    {{{    26,    -24,     28}, 0, {     0,      0}, {0x0d, 0xc8, 0x70, 0x00}}},
    {{{    30,    -32,     -4}, 0, {     0,      0}, {0x2f, 0x9f, 0xbe, 0x00}}},
    {{{    16,      4,    -17}, 0, {     0,      0}, {0xf9, 0x11, 0x83, 0x00}}},
...
// 0x0401A478
static const Vtx waluigi_right_hand_cap_r_logo_dl_vertex[] = {
...
// 0x0401A4C8
static const Vtx waluigi_right_hand_cap_hand_position_dl_vertex_group1[] = {
...
// 0x0401A5B8
static const Vtx waluigi_right_hand_cap_hand_position_dl_vertex_group2[] = {
...
// 0x0401A6B8
static const Vtx waluigi_right_hand_cap_hand_position_dl_vertex_group3[] = {
    {{{    35,      9,    -36}, 0, {     0,      0}, {0xe4, 0xf4, 0x85, 0xff}}},
...
// 0x0401A798
static const Vtx waluigi_right_hand_cap_top_dl_vertex_group1[] = {
...
// 0x0401A888
static const Vtx waluigi_right_hand_cap_top_dl_vertex_group2[] = {
...
// 0x0401A988
static const Vtx waluigi_right_hand_cap_top_dl_vertex_group3[] = {
    {{{    65,    -53,     55}, 0, {     0,      0}, {0xb7, 0x01, 0x67, 0xff}}},
    {{{    18,    -13,     33}, 0, {     0,      0}, {0x84, 0x10, 0xed, 0xff}}},
    {{{    29,    -82,     43}, 0, {     0,      0}, {0x95, 0xbd, 0x00, 0xff}}},
    {{{    70,    -52,     35}, 0, {     0,      0}, {0xc5, 0xde, 0x96, 0xff}}},
...
// 0x0401AA88
static const Vtx waluigi_right_hand_cap_top_dl_vertex_group4[] = {
    {{{   181,   -167,    138}, 0, {     0,      0}, {0x06, 0x88, 0x26, 0xff}}},
    {{{   273,   -105,    188}, 0, {     0,      0}, {0x5f, 0xbf, 0x34, 0xff}}},
...
// 0x0401AB08
static const Vtx waluigi_right_hand_cap_bottom_dl_vertex[] = {
    {{{    65,    -53,     55}, 0, {     0,      0}, {0xb7, 0x01, 0x67, 0xff}}},
    {{{   106,   -124,     90}, 0, {     0,      0}, {0x9d, 0xb2, 0x09, 0xff}}},
    {{{   137,   -137,    134}, 0, {     0,      0}, {0x9f, 0xdf, 0x49, 0xff}}},
    {{{    73,     11,     60}, 0, {     0,      0}, {0xbb, 0xfb, 0x6a, 0xff}}},
...
// 0x0401B2D0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group1[] = {
...
// 0x0401B3D0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group2[] = {
...
// 0x0401B4B0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group3[] = {
...
// 0x0401B5A0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group4[] = {
...
// 0x0401B6A0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group5[] = {
    {{{    -4,     38,      0}, 0, {     0,      0}, {0xd3, 0x66, 0x3c, 0xff}}},
...
// 0x0401B7A0
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group6[] = {
...
// 0x0401B890
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group7[] = {
...
// 0x0401B980
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group8[] = {
...
// 0x0401BA70
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group9[] = {
    {{{    84,     48,     24}, 0, {     0,      0}, {0xc2, 0x66, 0x28, 0xff}}},
...
// 0x0401BB70
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group10[] = {
    {{{     2,     -5,    -33}, 0, {     0,      0}, {0x47, 0x20, 0x9d, 0xff}}},
    {{{    14,     -1,    -22}, 0, {     0,      0}, {0x47, 0x20, 0x9d, 0x00}}},
...
// 0x0401BC50
static const Vtx waluigi_right_hand_peace_shared_dl_vertex_group11[] = {
    {{{   101,    -29,     15}, 0, {     0,      0}, {0x53, 0xa3, 0x15, 0xff}}},
    {{{    56,    -47,     -5}, 0, {     0,      0}, {0x0c, 0x87, 0xde, 0x00}}},
