...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0x01 /*death entry*/, LEVEL_BOB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(E_MODEL_NONE, 148, -253, -309, 0, 0, 0, 0x00000000, bhvLevelGCutscenes),
		OBJECT(E_MODEL_NONE, 229, -258, -643, 0, 0, 0, (1 << 16), bhvLevelGCutscenes),
		OBJECT(MODEL_NONE, -1486, 500, 130, 0, 0, 0, (0x01 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 8, 500, -1895, 0, -180, 0, (0x03 << 16), bhvWarp),
		OBJECT(MODEL_NONE, -63, 500, 1623, 0, -180, 0, (0x0A << 16), bhvSpinAirborneWarp),
	...
	AREA(3, bob_area_3),
		...
		WARP_NODE(0x0B, LEVEL_BOB, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_G_BRONTO_BURT, 5768, 5153, -1412, 0, 0, 0, 0x00000000, bhvGBrontoBurt),
	...
	AREA(4, bob_area_4),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BOB, 0x04, 0x01, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x04, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_BOB, 0x05, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0D, LEVEL_BOB, 0x03, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01/*death receive*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_ABILITY_SIGN, 7235, 808, 15721, 0, -49, 0, (5 << 16), id_bhvStaticObject),
		OBJECT(MODEL_ABILITY_SIGN, -13876, 237, 8376, 0, -40, 0, (4 << 16), id_bhvStaticObject),
		OBJECT(MODEL_NONE, 3852, 3467, -2928, 0, -180, 0, (11 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_ABILITY_SIGN, 4373, 3099, -2687, 0, -124, 0, (10 << 16), id_bhvStaticObject),
	...
	AREA(5, bob_area_5),
		...
		WARP_NODE(0xF1, LEVEL_BOB, 0x04, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x04, 0x0C, WARP_NO_CHECKPOINT),
