...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -3532, 879, -2882, 0, 45, 0, bob_dl_debris_mesh_layer_4),
		GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_kirblock_mesh_layer_1),
...
const GeoLayout bob_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 0, 0, 57509, 0, -100, 57509, geo_camera_main),
				GEO_OPEN_NODE(),
