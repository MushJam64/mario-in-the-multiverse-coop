...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_STAR_BOULDER, 15153, 1798, -4310, 0, 0, 0, (4<<24 | 4<<16), bhvCraneRock),
		OBJECT(MODEL_STAR_BOULDER, 21782, 1664, 444, 0, 0, 0, (4<<24 | 4<<16), bhvCraneRock),
		OBJECT(MODEL_STAR_BOULDER, 16464, 1749, 6422, 0, 0, 0, (4<<24 | 4<<16), bhvCraneRock),
		...
		OBJECT(MODEL_SPLAT_TARGET, -669, 5549, 927, 2, 45, -1, 0x00000000, bhvLevelSplatoonTarget),
		...
		OBJECT(MODEL_TARGET_BOX, 6523, 2948, 9364, 0, 0, 0, (1 << 16), bhvTargetBox),
		OBJECT(MODEL_SPLAT_TARGET, 1198, 4980, -932, 2, 45, -1, 0x00000000, bhvLevelSplatoonTarget),
		OBJECT(MODEL_SPLAT_TARGET, 2996, 5261, -2723, 2, 45, -1, 0x00000000, bhvLevelSplatoonTarget),
		...
		OBJECT(MODEL_NONE, 6394, 2948, 8728, 0, 180, 0, 0x00000000, bhvFloorSwitchTeleporter),
		OBJECT(MODEL_NONE, 1515, 2416, 3128, 0, 180, 0, 0x00000000, bhvFloorSwitchTeleporter),
		...
		//SEQ_C_SEA_ME_NOW
		SET_BACKGROUND_MUSIC(0x00, 0x4b),
