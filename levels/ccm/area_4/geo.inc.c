const GeoLayout ccm_area_4_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -11386, 0, 0, ccm_dl_first_section_geo_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, ccm_dl_first_section_geo_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_first_section_geo_mesh_layer_4),
		GEO_CLOSE_NODE(),
