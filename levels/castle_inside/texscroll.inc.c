...
void scroll_castle_inside_dl_Map_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 72;
	int width = 64 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(castle_inside_dl_Map_mesh_layer_1_vtx_0);
...
void scroll_gfx_mat_castle_inside_dl_acid_f3d_layer5() {
	...
	shift_t(mat, 12, PACK_TILESIZE(0, 16));
	shift_t(mat, 14, PACK_TILESIZE(0, 19));
