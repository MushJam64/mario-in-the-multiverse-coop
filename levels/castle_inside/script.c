...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(36/*jk more exits*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(37, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		MARIO_POS(0x01, 0, -2062, 1612, -979),
		...
		OBJECT(MODEL_NONE, 1620, 2112, -830, 0, -76, 0, (36 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -7681, 3158, 21, 0, 83, 0, (37 << 16), bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_MUMBO_JUMBO, 227, 1612, -2537, 0, 0, 0, 0x00000000, bhvMumbo),
